...
const TECH_TAGS = [
  {
    name: "Python",
    note: "Primary language for ML, ETL, and analysis",
  },
  {
    name: "SQL",
    note: "Advanced queries, window functions, stored procs",
  },
  {
    name: "Java",
    note: "Object-oriented programming and application development",
  },
  {
    name: "Power BI",
    note: "Data modeling, DAX, and interactive dashboards",
  },
  {
    name: "VS Code",
    note: "Primary IDE for development and debugging",
  },
  {
    name: "JavaScript",
    note: "Frontend scripting and interactive web development",
  },
  {
    name: "MATLAB",
    note: "Mathematical modeling and numerical computing",
  },
  { name: "HTML/CSS", note: "Web structure and styling" },
  {
    name: "PHP",
    note: "Server-side scripting and backend logic",
  },
  ...
  {
    name: "Docker",
    note: "Containerization and environment reproducibility",
  },
];
...
function MeshBg({
  ...
  return (
    <div className="fixed inset-0 -z-10 overflow-hidden pointer-events-none">
      <div
        className={`absolute inset-0 transition-colors duration-700 ${isDark ? "bg-[#040D1A]" : "bg-[#EEF2F8]"}`}
      />
      <div
        className="absolute -top-1/4 -left-1/4 w-3/4 h-3/4 rounded-full opacity-[0.25] animate-[blob1_9s_ease-in-out_infinite]"
        style={{
          background: `radial-gradient(circle, ${accentHex} 0%, transparent 65%)`,
        }}
      />
      <div
        className="absolute top-1/3 -right-1/4 w-2/3 h-2/3 rounded-full opacity-[0.15] animate-[blob2_11s_ease-in-out_infinite]"
        style={{
          background: `radial-gradient(circle, ${accentHex} 0%, transparent 65%)`,
        }}
      />
      <div
        className="absolute -bottom-1/4 left-1/4 w-1/2 h-1/2 rounded-full opacity-[0.12] animate-[blob3_13s_ease-in-out_infinite]"
        style={{
          background: `radial-gradient(circle, ${accentHex} 0%, transparent 65%)`,
        }}
      />
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Back */}
        <div
          className={`absolute inset-0 rounded-2xl p-6 flex flex-col gap-3 shadow-2xl ${isDark ? "bg-[#091629] border border-white/10" : "bg-white border border-slate-200"}`}
          style={{
            backfaceVisibility: "hidden",
        ...
        >
          <div className="mb-1">
            ...
            >
              ICT Undergraduate & Aspiring Data Scientist
            </p>
          </div>
          {[
            ...
            [
              "Degree",
              "Information and Communication Technology (ICT) – B.Sc. (General)",
            ],
            ["Graduating", "2028"],
            ...
            <div
              key={k}
              className={`flex justify-between text-sm border-b pb-2 ${isDark ? "border-white/8" : "border-slate-100"}`}
            >
              <span
                className={
              ...
              <span
                className={`font-semibold text-right max-w-[60%] ${isDark ? "text-white/90" : "text-slate-800"}`}
              >
                {v}
              </span>
            </div>
          ...
          <div className="flex gap-2 mt-auto">
            {[Github, Linkedin, Mail].map((Icon, i) => (
              <button
                key={i}
                className={`p-2 rounded-lg transition-colors ${isDark ? "bg-white/8 hover:bg-white/15" : "bg-slate-100 hover:bg-slate-200"}`}
...
function SkillGauge({
  ...
  return (
    <div ref={ref} className="flex flex-col items-center gap-3">
        ...
        >
          ...
          <circle
            ...
            style={{
              ...
              filter: `drop-shadow(0 0 7px ${accentHex}90)`,
            }}
          />
        </svg>
      ...
      <span
        className={`text-xs font-semibold text-center leading-tight ${isDark ? "text-white/60" : "text-slate-500"}`}
        style={{ fontFamily: "'DM Mono', monospace" }}
      >
        {label}
      </span>
    ...
    >
      ...
      >
        {iconSrc ? (
          ...
          <span
            className={`text-base font-bold ${isDark ? "text-white/70" : "text-slate-600"}`}
          >
      ...
      {/* Name below */}
      <span
        className={`text-xs font-semibold text-center leading-tight max-w-[80px] ${isDark ? "text-white/60" : "text-slate-500"
          }`}
        style={{ fontFamily: "'DM Mono', monospace" }}
      >
        {name}
      ...
      <AnimatePresence>
        {show && (
          ...
          >
            {note}
            <div
              className={`absolute top-full left-1/2 -translate-x-1/2 w-0 h-0 border-l-4 border-r-4 border-t-4 border-l-transparent border-r-transparent ${isDark ? "border-t-[#0D2044]" : "border-t-white"
                }`}
            />
          </motion.div>
        )}
...
function ProjectCard({
  ...
  return (
    <div
      ...
      style={{
        boxShadow: `0 4px 24px ${isDark ? "rgba(0,0,0,0.5)" : "rgba(0,0,0,0.07)"}`,
      }}
    >
      ...
      <div className="p-5">
        ...
        <h3
          className={`font-bold text-base mb-2 ${isDark ? "text-white" : "text-slate-900"}`}
          style={{ fontFamily: "'Outfit', sans-serif" }}
        >
          {project.title}
        </h3>
        <p
          className={`text-sm leading-relaxed mb-4 ${isDark ? "text-white/55" : "text-slate-500"}`}
        >
          {project.desc}
        </p>
        <div className="grid grid-cols-2 gap-1.5">
          {project.metrics.slice(0, 2).map((m) => (
            <div
              key={m}
              className={`text-xs px-2 py-1.5 rounded-lg font-medium ${isDark ? "bg-white/[0.05] text-white/65" : "bg-slate-50 text-slate-600"}`}
              style={{ fontFamily: "'DM Mono', monospace" }}
            >
              {m}
            </div>
      ...
      >
        <div className="relative h-52 bg-slate-800 overflow-hidden">
          ...
          <div
            className="absolute inset-0"
            style={{
              background: `linear-gradient(to top, ${isDark ? "#071220" : "#fff"} 0%, transparent 55%)`,
            }}
          />
          <button
            onClick={onClose}
        ...
        <div className="p-6">
          ...
          <h3
            className={`text-2xl font-extrabold mb-3 ${isDark ? "text-white" : "text-slate-900"}`}
            style={{ fontFamily: "'Outfit', sans-serif" }}
          >
            {project.title}
          </h3>
          <p
            className={`leading-relaxed mb-5 ${isDark ? "text-white/65" : "text-slate-600"}`}
          >
            {project.detail}
          </p>
          <div className="grid grid-cols-2 gap-3 mb-5">
            {project.metrics.map((m) => (
              <div
                key={m}
                className={`flex items-center gap-2 p-3 rounded-xl text-sm font-semibold ${isDark ? "bg-white/[0.05] text-white/80" : "bg-slate-50 text-slate-700"}`}
              >
                <Check
                  size={13}
                  style={{ color: accentHex, flexShrink: 0 }}
                />
                {m}
              </div>
            ))}
          ...
          <p
            className={`text-xs font-bold uppercase tracking-widest mb-2 ${isDark ? "text-white/35" : "text-slate-400"}`}
            style={{ fontFamily: "'DM Mono', monospace" }}
          >
            Stack
          </p>
          <div className="flex flex-wrap gap-2 mb-6">
            {project.stack.map((s) => (
              <span
                key={s}
                className={`px-3 py-1 rounded-lg text-xs font-semibold border ${isDark ? "bg-white/[0.05] border-white/[0.1] text-white/65" : "bg-slate-50 border-slate-200 text-slate-600"}`}
              >
                {s}
              </span>
            ))}
...
function ContactForm({
  ...
  const fieldBase = (f: keyof ContactFormData) =>
    ...
    return (
      ...
      >
        <motion.div
          ...
          style={{
            background: accentHex,
            boxShadow: `0 0 32px ${accentHex}60`,
          }}
        >
          <Check
            size={28}
            style={{ color: isDark ? "#040D1A" : "#fff" }}
          />
        </motion.div>
        <h3
    ...
    >
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
        <button
          ...
          style={{ fontFamily: "'Outfit', sans-serif" }}
        >
          Nirmal<span style={{ color: accentHex }}>.</span>
          Colambage
        </button>
      ...
      <div className="max-w-7xl mx-auto px-6 py-16 w-full grid md:grid-cols-2 gap-12 lg:gap-20 items-center">
        ...
        >
          <div className="flex items-center gap-2.5 mb-7">
            ...
            <span
              className={`text-sm font-semibold ${isDark ? "text-white/55" : "text-slate-500"}`}
              style={{ fontFamily: "'DM Mono', monospace" }}
            >
          ...
          <h1
            className={`text-5xl md:text-6xl xl:text-[5.5rem] font-extrabold leading-[1.02] tracking-tight mb-5 ${isDark ? "text-white" : "text-slate-900"}`}
            style={{ fontFamily: "'Outfit', sans-serif" }}
          >
            Hi, I'm{" "}
            <span
              style={{
                color: accentHex,
                textShadow: `0 0 30px ${accentHex}60`,
              }}
            >
              Nirmal Colambage
            </span>
          ...
          <div
            className={`text-xl md:text-2xl font-semibold mb-7 min-h-[1.8em] flex items-center gap-1 ${isDark ? "text-white/55" : "text-slate-500"}`}
            style={{ fontFamily: "'Outfit', sans-serif" }}
          >
            <span style={{ color: accentHex }}>{text}</span>
            <span
              className="w-0.5 h-6 inline-block animate-pulse rounded-sm"
              style={{ background: accentHex }}
            />
          </div>
          <p
            className={`text-base leading-relaxed mb-10 max-w-md ${isDark ? "text-white/45" : "text-slate-500"}`}
          >
            ICT Undergraduate | Aspiring Data Scientist & AI
            Enthusiast
          </p>
          ...
          <div className="flex gap-5">
            {[
              {
                Icon: Github,
                href: "https://github.com/ravinducolambage-hue",
                label: "github",
              },
              {
                Icon: Linkedin,
                href: "https://www.linkedin.com/in/nirmal-colambage/",
                label: "linkedin",
              },
              {
                Icon: Mail,
                href: "mailto:ravinducolambage@gmail.com",
                label: "mail",
              },
            ].map(({ Icon, href, label }) => (
              <a
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <img
          src="https://images.unsplash.com/photo-1518770660439-4636190af475?w=1400&h=900&fit=crop&auto=format"
          alt=""
      ...
      <div className="relative max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-16 mb-16">
          <div className="space-y-4">
            <p
              className={`text-base leading-relaxed ${isDark ? "text-white/65" : "text-slate-600"}`}
            >
              I am a second-year Information Technology
              undergraduate student at the University of Sri
              Jayewardenapura, specializing in data science and
              data analysis. My work bridges the gap between
              structured analytical insights and practical
              engineering by building optimized SQL databases,
              designing interactive Power BI dashboards, and
              developing clean Python workflows that translate
              complex data into clear business value.
            </p>
            <p
              className={`text-base leading-relaxed ${isDark ? "text-white/65" : "text-slate-600"}`}
            >
              I currently balance my academic studies with
              real-world execution as a part-time Assistant
              Sales Manager at Power Hands Plantation. When I am
              not writing scripts or managing repositories on
              GitHub, I combine my technical skills with my
              passion for sports analytics, specifically
              focusing on cricket statistics and university
              sports performance. I care deeply about making
              data accessible, intuitive, and highly actionable
              for decision-makers.
            </p>
          </div>
          <div className="grid grid-cols-2 gap-4">
            {[
              ["1", "Projects"],
              ["Still Searching", "Internships"],
              ["1.3K", "Users Reached"],
              ["2.30", "GPA"],
            ].map(([v, l]) => (
              <div
                key={l}
                className={`p-5 rounded-2xl border shadow-md ${glassCard(isDark)}`}
              >
                <p
                  className={`${v.length > 5 ? "text-xl sm:text-2xl" : "text-3xl"} font-extrabold mb-1`}
                  style={{
                    color: accentHex,
                    fontFamily: "'Outfit', sans-serif",
                  }}
        ...
        {/* Skill gauges */}
        <div
          className={`p-8 rounded-2xl border shadow-lg mb-12 ${glassCard(isDark)}`}
        >
          <SectionLabel
            text="Core Proficiency"
            hex={accentHex}
          />
        ...
        <div>
          ...
          <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 gap-3 mt-4 justify-items-center">
            {TECH_TAGS.map((t) => (
              <TechPill
                key={t.name}
                name={t.name}
    ...
    <section id="projects" className="py-24">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-10">
          ...
          <a
            href="#"
            className={`flex items-center gap-1.5 text-sm font-semibold transition-colors ${isDark ? "text-white/45 hover:text-white/80" : "text-slate-400 hover:text-slate-700"}`}
          >
        ...
        <div className="flex flex-wrap gap-2 mb-10 items-center">
              ...
              style={
                tag === t
                  ? {
                    background: accentHex,
                    color: isDark ? "#040D1A" : "#fff",
                    boxShadow: `0 4px 16px ${accentHex}45`,
                  }
                  : {
                    background: isDark
          ...
          <span
            className={`ml-2 text-xs font-medium ${isDark ? "text-white/35" : "text-slate-400"}`}
            style={{ fontFamily: "'DM Mono', monospace" }}
          >
    ...
    <section id="contact" className="py-24">
      <div className="max-w-5xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div>
            <p
              className={`text-base leading-relaxed mb-8 ${isDark ? "text-white/55" : "text-slate-500"}`}
            >
              Open to data science internships, part-time
              analytics roles, and interesting research
            ...
            {[
              {
                Icon: Mail,
                label: "Email",
                value: "ravinducolambage@gmail.com",
                href: "mailto:ravinducolambage@gmail.com",
              },
              {
                Icon: Linkedin,
                label: "LinkedIn",
                value: "linkedin.com/in/nirmal-colambage",
                href: "https://www.linkedin.com/in/nirmal-colambage/",
              },
              {
                Icon: Github,
                label: "GitHub",
                value: "github.com/ravinducolambage-hue",
                href: "https://github.com/ravinducolambage-hue",
              },
              ...
              >
                ...
                <div>
                  <p
                    className={`text-xs ${isDark ? "text-white/35" : "text-slate-400"}`}
                    style={{
                      fontFamily: "'DM Mono', monospace",
                    }}
                  >
                  ...
                  <p
                    className={`text-sm font-semibold ${isDark ? "text-white/85" : "text-slate-800"}`}
                  >
                    {value}
                  </p>
                </div>
                <ExternalLink
                  size={12}
                  className={`ml-auto opacity-0 group-hover:opacity-100 transition-opacity ${isDark ? "text-white/40" : "text-slate-400"}`}
                />
              </a>
            ))}
          </div>
          ...
          {/* Form */}
          <div
            className={`p-7 rounded-2xl border shadow-xl ${glassCard(isDark)}`}
          >
            <ContactForm
              isDark={isDark}
              accentHex={accentHex}
...
function Footer({
  ...
  return (
    <footer
      className={`border-t py-8 px-6 ${isDark ? "border-white/[0.07]" : "border-slate-200"}`}
    >
      ...
      <AnimatePresence>
        {showTop && (
          <motion.button
            ...
            style={{
              background: accentHex,
              boxShadow: `0 4px 20px ${accentHex}60`,
            }}
          >
...
export default function App() {
  ...
  return (
    <div
      className={`min-h-screen transition-colors duration-500 ${isDark ? "text-white" : "text-slate-900"}`}
